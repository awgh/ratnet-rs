...
async fn test_basic_operations(node: &Arc<FilesystemNode>) -> Result<(), Box<dyn std::error::Error>> {
...
async fn test_contact_management(node: &Arc<FilesystemNode>) -> Result<(), Box<dyn std::error::Error>> {
    ...
    node.add_contact(contact_name.to_string(), contact_key.clone()).await?;
...
async fn test_channel_management(node: &Arc<FilesystemNode>) -> Result<(), Box<dyn std::error::Error>> {
...
async fn test_profile_management(node: &Arc<FilesystemNode>) -> Result<(), Box<dyn std::error::Error>> {
...
async fn test_peer_management(node: &Arc<FilesystemNode>) -> Result<(), Box<dyn std::error::Error>> {
